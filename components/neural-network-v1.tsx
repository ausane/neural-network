...
export function NeuralNetworkV1Component() {
  ...
  const addNode = () => {
    ...
    nodesRef.current = [...nodesRef.current, newNode] // Update ref
  }

  const removeNode = () => {
    setNodes((prevNodes) => prevNodes.slice(0, -1))
    nodesRef.current = nodesRef.current.slice(0, -1) // Update ref
  }
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 gap-2 px-4 flex max-sm:w-full max-sm:flex-col sm:space-x-4">
